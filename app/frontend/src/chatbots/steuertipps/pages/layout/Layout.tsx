        ...
        <div className={styles.layout}>
            <header className={styles.header} role="banner">
                <div className={styles.headerContainer}>
                    <Link aria-label="Go to home page" className={styles.logoContainer} to="/steuertipps">
                        <img alt="Steuertipps logo" className={styles.brandWordmark} src={steuertippsLogo} />
                    </Link>

...
import bbsaNavLogo from "../../../../assets/bbsa-nav-logo.png";
        ...
        <div className={styles.layout}>
            <header className={styles.header} role="banner">
                <div className={styles.headerContainer}>
                    <Link aria-label="Go to home page" className={styles.logoContainer} to="/bbsa">
                        <img alt="Breitband.Tirol Logo" className={styles.brandWordmark} src={bbsaNavLogo} />
                    </Link>

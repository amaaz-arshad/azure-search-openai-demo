...
export const chatbotDefinitions: ChatbotDefinition[] = [
    ...
    { ...knollChatbot, llm: "gpt-5.4-mini", reasoningEffort: "high", mode: "tutor-qna", agenticRetrievalDefault: false },
    { ...lemonChatbot, llm: "gpt-5.4-mini", reasoningEffort: "high", mode: "tutor-qna", agenticRetrievalDefault: true },

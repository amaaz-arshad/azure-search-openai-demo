...
const Chat = () => {
    ...
    // PublishOne2 is a Q&A-only bot. Unlike publishone (pinned to English) its corpus is mixed
    // German/English, so the UI and the answer language both follow the resolved browser locale.
    const chatbotCategory = "publishone2";
    ...
    const getConfig = async () => {
        configApi().then(config => {
            const effectiveConfig = applyChatbotSpeechFeatureFlags("publishone2", config);

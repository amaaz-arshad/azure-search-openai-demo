...
// SNAP-branded fork of the shared NoPage. The shared component is hardcoded with
// nerilio links and is re-exported by other bots, so snap gets its own copy that
// reuses the shared styles/robot asset but points at snap.de.
const HOME_URL = "https://www.snap.de";
const CONTACT_EMAIL = "info@snap.de";
const CONTACT_URL = `mailto:${CONTACT_EMAIL}`;
const IMPRESSUM_URL = "https://www.snap.de/impressum/";
const PRIVACY_URL = "https://www.snap.de/datenschutz/";
...
export function Component(): JSX.Element {
    ...
    return (
        <div className={styles.page}>
            <Helmet>
                <title>{t("rootLanding.pageTitle", { lng: noPageLanguage, defaultValue: "Page not found | SNAP" })}</title>
            </Helmet>
            ...
            <main className={styles.main}>
                <div className={styles.card}>
                    <img alt="SNAP" className={styles.robot} src={robotImage} />

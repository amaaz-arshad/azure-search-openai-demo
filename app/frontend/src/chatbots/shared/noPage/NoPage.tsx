...
const HOME_URL = "https://nerilio.ai";
const CONTACT_EMAIL = "hallo@nerilio.ai";
const CONTACT_URL = `mailto:${CONTACT_EMAIL}`;
const IMPRESSUM_URL = "https://nerilio.ai/impressum";
const PRIVACY_URL = "https://nerilio.ai/datenschutz";
        ...
        <div className={styles.page}>
            ...
            <main className={styles.main}>
                <div className={styles.card}>
                    <img alt="nerilio" className={styles.robot} src={robotImage} />

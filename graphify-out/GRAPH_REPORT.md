# Graph Report - agentic-retrieval  (2026-05-06)

## Corpus Check
- 1329 files · ~2,381,066 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6726 nodes · 19391 edges · 97 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 5420 edges (avg confidence: 0.68)
...
Cohesion: 0.01
Nodes (863): a(), h(), R(), e(), _i(), _o(), pd(), r() (+855 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (518): ABC, add_image_citation(), BaseBlobManager, BlobListEntry, BlobManager, BlobProperties, Downloads a blob from Azure Storage.         If user_oid is provided, it checks, Uploads an image from a document to ADLS in a directory structure:         {use (+510 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (158): clearStoredSession(), readStoredSession(), writeStoredSession(), CK(), oR(), PG(), pl(), Pse() (+150 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (497): handleSubmit(), hf(), Yn(), ze(), _1(), $6(), a9(), ab() (+489 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (276): apply_saved_chatbot_prompt_override(), build_chat_model_deployments(), build_prompt_admin_payload(), build_simple_auth_required_response(), cancel_chatbot_upload(), cancel_managed_upload(), chat(), chat_stream() (+268 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (161): JSONEncoder, list_uploaded(), LLMOnlySpanExporter, Lists the uploaded documents for the current user.     Only returns files direc, Lists the uploaded documents for the current user.     Only returns files direc, Lists the uploaded documents for the current user.     Only returns files direc, Lists the uploaded documents for the current user.     Only returns files direc, Wraps an exporter and only forwards LLM-related spans. (+153 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (140): AdlsGen2Setup, main(), Sets up a Data Lake Storage Gen 2 account with sample data and access control, Initializes the command          Parameters         ----------         data_, close_clients(), delete_uploaded(), AsyncTokenCredential, BaseMetric (+132 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (242): ab(), Ac(), ad(), Ag(), ah(), Ai(), An(), ao() (+234 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (81): auth_setup(), AuthError, get_token_auth_header(), Validate an access token is issued by Entra, getSpeechRecognitionLocale(), getSpeechToken(), CosmosDBMigrator, migrate_cosmosdb_data() (+73 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (71): getCurrentProfile(), getCurrentSession(), isAuthenticated(), isEmailValid(), login(), logout(), normalizeEmail(), parseProfile() (+63 more)
...
Cohesion: 0.06
Nodes (11): list_managed_uploads(), parse_positive_int_query_param(), upload(), upload_managed_files(), CategoryUploadStrategy, encode_token(), ChatbotUploadStrategy, count_pdf_pages() (+3 more)
...
Cohesion: 0.14
Nodes (22): buildInitialAssistantPair(), buildInitialConversation(), clearChat(), createClientSessionId(), getConfig(), getCurrentSessionState(), getLastRealQuestion(), handleAsyncRequest() (+14 more)
...
Cohesion: 0.14
Nodes (12): appServicesLogout(), checkLoggedIn(), fetchAuthSetup(), getAppServicesToken(), getRedirectUri(), getToken(), getTokenClaims(), getUsername() (+4 more)
...
Cohesion: 0.17
Nodes (22): AutoBlobIndexer, AutoBlobIndexerConfig, AutoBlobIndexResult, blob_name_from_event_grid_subject(), build_file(), content_type_for_filename(), normalize_blob_name(), normalize_prefix() (+14 more)
...
- **Why does `set()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 11`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 20`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `Page` connect `Community 1` to `Community 22`, `Community 15`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `update()` connect `Community 4` to `Community 0`, `Community 1`, `Community 5`, `Community 7`, `Community 11`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Are the 128 inferred relationships involving `BlobManager` (e.g. with `LLMOnlySpanExporter` and `JSONEncoder`) actually correct?**
  _`BlobManager` has 128 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 124 inferred relationships involving `File` (e.g. with `LLMOnlySpanExporter` and `JSONEncoder`) actually correct?**
  _`File` has 124 INFERRED edges - model-reasoned connections that need verification._
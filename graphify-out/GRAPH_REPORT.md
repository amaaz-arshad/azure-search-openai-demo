...
## Corpus Check
- 1426 files · ~2,471,647 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6439 nodes · 17936 edges · 335 communities detected
- Extraction: 71% EXTRACTED · 29% INFERRED · 0% AMBIGUOUS · INFERRED: 5221 edges (avg confidence: 0.65)
...
Cohesion: 0.0
Nodes (903): sortCategories(), $$(), _0(), _1(), $3(), _4(), $5(), $6() (+895 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (553): ABC, JSONEncoder, LLMOnlySpanExporter, Lists the uploaded documents for the current user.     Only returns files direc, Lists the uploaded documents for the current user.     Only returns files direc, Lists the uploaded documents for the current user.     Only returns files direc, Lists the uploaded documents for the current user.     Only returns files direc, Lists the uploaded documents for the current user.     Only returns files direc (+545 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (132): clearStoredSession(), readStoredSession(), writeStoredSession(), generate_ground_truth_ragas(), get_azure_credential(), get_search_documents(), getInitialInternalAuthenticationState(), setInternalAuthenticationState() (+124 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (254): apply_saved_chatbot_prompt_override(), build_chat_model_deployments(), build_prompt_admin_payload(), build_simple_auth_required_response(), cancel_chatbot_upload(), cancel_managed_upload(), chat(), chat_stream() (+246 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (155): askApi(), cancelChatbotUploadApi(), chatApi(), configApi(), deleteAllChatbotUploadedFilesApi(), deleteChatbotUploadedFileApi(), deleteChatHistoryApi(), deleteUploadedFileApi() (+147 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (147): close_clients(), test_publishone_forces_english_for_german_browser_locale(), parse_file(), cleanup_data(), Cleans up the given content using regexes     Args:         data: (str): The d, Parses the given content.         To learn more, please visit https://pypi.org/, build_hyrox_sections_if_applicable(), choose_split_boundary() (+139 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (105): create_app(), get_openlit_llm_only_disabled_instrumentors(), index(), AsyncHttpTransport, ChatbotConfig, Load the ChatbotConfig for a given chatbot name, or None if no config.py exists., Load the ChatbotConfig for a given chatbot name, or None if no config.py exists., auth_client() (+97 more)

### Community 7 - "Community 7"
Cohesion: 0.04
Nodes (142): formatProfileDate(), formatTimestamp(), category_of(), get_question(), key_point_count(), max_points(), HYROX Youngstars Coach Assessment — question pool.  Auto-generated from hyrox-, Return the pooled question with this 1..32 number, or None if unknown. (+134 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (71): AdlsGen2Setup, main(), Sets up a Data Lake Storage Gen 2 account with sample data and access control, Initializes the command          Parameters         ----------         data_, free_port(), fulfill_chat_stream_snapshot(), handle_config_with_browser_history(), _hyrox_chat_response() (+63 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (42): list_uploaded(), blob_name_from_file_name(), normalize_blob_prefix(), Downloads a blob from Azure Blob Storage.          Args:             blob_pat, sourcepage_from_file_page(), remove_blobs_with_prefix(), build_code_email_html(), build_secret_hash() (+34 more)
...
Cohesion: 0.04
Nodes (48): embed_demo(), handleSubmit(), copy_tree(), main(), Synchronize prepdocslib ingestion library to function apps. This script ensures, CustomUvicornWorker, delete_documents_by_category function, delete_documents_by_category main (+40 more)

### Community 12 - "Community 12"
Cohesion: 0.09
Nodes (72): append_tag(), build_document_content(), build_feed_document(), build_folder_context_lines(), build_publishone_feed_sections(), build_tags(), collect_direct_meta_fields(), collect_direct_value_fields() (+64 more)

### Community 13 - "Community 13"
Cohesion: 0.1
Nodes (30): clearActiveSessionId(), keyFor(), readActiveSessionId(), writeActiveSessionId(), parseProgressValue(), buildInitialAssistantPair(), buildInitialConversation(), clearChat() (+22 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (9): Es(), GT(), gue(), Hn, Ji(), que(), rde, xue() (+1 more)
...
- **Thin community `Community 26`** (18 nodes): `dO`, `.addNamespaces()`, `.addResource()`, `.addResourceBundle()`, `.addResources()`, `.constructor()`, `.getDataByLanguage()`, `.getResource()`, `.getResourceBundle()`, `.hasLanguageSomeTranslations()`, `.hasResourceBundle()`, `.removeNamespaces()`, `.removeResourceBundle()`, `.toJSON()`, `.emit()`, `.loaded()`, `.getResource()`, `.setResolvedLanguage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 36`** (16 nodes): `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem.tsx`, `HistoryItem()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (16 nodes): `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput.tsx`, `SpeechInput()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (16 nodes): `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton.tsx`, `SettingsButton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (16 nodes): `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `SupportingContentParser.ts`, `parseSupportingContentItem()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (16 nodes): `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage.tsx`, `UserChatMessage()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (16 nodes): `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker.tsx`, `LanguagePicker()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (15 nodes): `getStepLabel()`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`, `agentPlanUtils.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (15 nodes): `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `ThoughtProcess.tsx`, `truncateImageUrl()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (11 nodes): `j7()`, `.closeConnection()`, `.constructor()`, `.containsKey()`, `.deleteDatabase()`, `.getItem()`, `.getKeys()`, `.open()`, `.removeItem()`, `.setItem()`, `.validateDbIsOpen()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 82`** (1 nodes): `Error Response Module`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 738`** (1 nodes): `Contrast: a normal mid-assessment turn (graded answer + the next question chaine`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `set()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 11`, `Community 12`, `Community 14`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `update()` connect `Community 6` to `Community 0`, `Community 1`, `Community 9`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `Page` connect `Community 5` to `Community 1`, `Community 11`, `Community 12`, `Community 21`?**

# Graph Report - agentic-retrieval  (2026-08-21)

## Corpus Check
- 1917 files · ~2,504,793 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13210 nodes · 24091 edges · 2043 communities (1383 shown, 660 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 4347 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e04bd4cd`
...
1. `BlobManager` - 258 edges
2. `File` - 181 edges
3. `SearchManager` - 146 edges
4. `$fxv#0` - 143 edges
5. `parameters` - 143 edges
6. `ImageEmbeddings` - 118 edges
7. `Section` - 117 edges
...
- `get_request_route_chatbot_name()` --calls--> `test_route_name_ignores_unknown_embed_referer()`  [INFERRED]
  app/backend/app.py → tests/test_app.py
- `get_request_route_chatbot_name()` --calls--> `test_route_name_still_resolves_plain_chatbot_referer()`  [INFERRED]
  app/backend/app.py → tests/test_app.py
- `format_as_ndjson()` --calls--> `test_format_as_ndjson()`  [INFERRED]
  app/backend/app.py → tests/test_app.py
- `get_chatbot_config()` --calls--> `test_config_loads_with_expected_values()`  [INFERRED]
  app/backend/approaches/chatbot_config_registry.py → tests/test_hyrox_assessment.py
...
- 1-file cycle: `app/backend/core/chatbotpromptstore.py -> app/backend/core/chatbotpromptstore.py`
- 1-file cycle: `app/backend/core/chatbotregistrystore.py -> app/backend/core/chatbotregistrystore.py`
- 1-file cycle: `app/backend/core/chatbotsessioncounterstore.py -> app/backend/core/chatbotsessioncounterstore.py`
- 1-file cycle: `app/backend/core/freeauth.py -> app/backend/core/freeauth.py`
- 1-file cycle: `tests/test_telemetry_routes.py -> tests/test_telemetry_routes.py`
- 1-file cycle: `app/backend/approaches/chatbots/hyrox_assessment/visits.py -> app/backend/approaches/chatbots/hyrox_assessment/visits.py`
- 1-file cycle: `app/backend/core/telemetry/aggregate.py -> app/backend/core/telemetry/aggregate.py`
- 1-file cycle: `app/backend/core/telemetry/recorder.py -> app/backend/core/telemetry/recorder.py`
- 1-file cycle: `app/backend/core/telemetry/records.py -> app/backend/core/telemetry/records.py`
- 1-file cycle: `app/backend/core/telemetry/store.py -> app/backend/core/telemetry/store.py`
- 1-file cycle: `tests/test_hyrox_visits.py -> tests/test_hyrox_visits.py`
- 1-file cycle: `app/frontend/src/chatbots/agindo/components/Example/Example.tsx -> app/frontend/src/chatbots/agindo/components/Example/Example.tsx`
- 1-file cycle: `app/frontend/src/chatbots/bbsa/components/Example/Example.tsx -> app/frontend/src/chatbots/bbsa/components/Example/Example.tsx`
- 1-file cycle: `app/frontend/src/chatbots/cbtx/api/index.ts -> app/frontend/src/chatbots/cbtx/api/index.ts`
- 1-file cycle: `app/frontend/src/chatbots/cbtx/components/Example/Example.tsx -> app/frontend/src/chatbots/cbtx/components/Example/Example.tsx`
- 1-file cycle: `app/frontend/src/chatbots/demo/components/Example/Example.tsx -> app/frontend/src/chatbots/demo/components/Example/Example.tsx`
- 1-file cycle: `app/frontend/src/chatbots/fbn/components/Example/Example.tsx -> app/frontend/src/chatbots/fbn/components/Example/Example.tsx`
- 1-file cycle: `app/frontend/src/chatbots/free/components/Example/Example.tsx -> app/frontend/src/chatbots/free/components/Example/Example.tsx`
- 1-file cycle: `app/frontend/src/chatbots/hyrox-assessment/components/Example/Example.tsx -> app/frontend/src/chatbots/hyrox-assessment/components/Example/Example.tsx`
...
## Communities (2043 total, 660 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (70): Class that splits pages into smaller chunks. This is required because embedding, SentenceTextSplitter, ChunkStub, SectionStub, test_text_processor_process_document_handles_missing_figures(), pytest_generate_tests(), Parametrize the test_doc fixture with all the pdf files in the test-data directo, Figure at very start of page should be emitted (regression test for missing emis (+62 more)

### Community 1 - "Community 1"
Cohesion: 0.12
Nodes (28): assignSeriesColors(), hashString(), SERIES_COLORS, STATUS_COLORS, statusColor(), STEP_TYPE_COLORS, stepTypeColor(), formatCost() (+20 more)

### Community 2 - "Community 2"
Cohesion: 0.16
Nodes (29): Any, File, Section, build_chunk_texts(), build_fhg_sections_if_applicable(), build_metadata_lines(), FhgPreparedDocument, get_optional_string_field() (+21 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (12): CategoryUploadStrategy, Top-level blob prefixes that hold real category content. Gated to known, Strategy for managing the shared content files of a search category.     Every, FakeBlobManager, FakeSearchManager, filename_token(), make_manager(), test_add_file_replaces_documents_from_other_ingestion_paths() (+4 more)
...
Cohesion: 0.05
Nodes (26): Props, pivotItemDisabledStyle, Props, Props, Claim, Props, pivotItemDisabledStyle, Props (+18 more)
...
Cohesion: 0.06
Nodes (51): OpenAIEmbeddings, SearchInfo, AsyncTokenCredential, AzureKeyCredential, build_default_semantic_search(), Class to manage a search service. It can create indexes, and update or remove se, Creates one or more Knowledge Bases in the search index based on desired knowled, SearchManager (+43 more)
...
Cohesion: 0.05
Nodes (124): Any, AsyncTokenCredential, SearchInfo, Namespace, AsyncOpenAI, AsyncTokenCredential, Namespace, OpenAIEmbeddings (+116 more)
...
Cohesion: 0.06
Nodes (63): get_question(), max_points(), module_questions(), Return the question with this 1..52 number, or None if unknown., The point cap for question ``number`` (0 if unknown)., Ordered question numbers in ``module_key`` (empty if unknown)., _drive_to_final_question(), _grade_first_messages() (+55 more)
...
Cohesion: 0.08
Nodes (16): datetime, list_uploaded(), Lists the uploaded documents for the current user.     Only returns files direct, setup_clients(), format_utc(), copy_tree(), main(), Path (+8 more)

### Community 15 - "Community 15"
Cohesion: 0.10
Nodes (10): AdlsGen2Setup, main(), Any, AsyncTokenCredential, DataLakeDirectoryClient, Sets up a Data Lake Storage Gen 2 account with sample data and access control, Initializes the command          Parameters         ----------         data_, MockFileClient (+2 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (71): KnowledgeBaseRetrievalClient, Document, Replace [ref_id:<id>] tokens with document citation, web URL, or SharePoint web_, Extract text/image sources & citations from documents.          Args:, Whether a retrieved document's own `url` may become its citation.          Bot, Downloads a blob from either Azure Blob Storage or Azure Data Lake Storage and r, SharePointResult, WebResult (+63 more)
...
Cohesion: 0.14
Nodes (28): Any, ChatbotRegistryRecord, ChatbotRegistryStore, get_record_public_id(), mint_public_id(), Return a dynamic record's stored public ID, or None when it has not been minted, Mint a public ID for a new dynamic bot, avoiding every ID already in use., assert_not_reserved() (+20 more)
...
Cohesion: 0.05
Nodes (78): AdlsBlobManager, Any, AsyncOpenAI, AsyncStream, BlobManager, ChatCompletion, ChatCompletionChunk, ChatCompletionMessageParam (+70 more)

### Community 25 - "Community 25"
Cohesion: 0.08
Nodes (22): AsyncHttpTransport, AsyncTokenCredential, auth_client(), auth_public_documents_client(), client(), client_with_expiring_token(), knowledgebase_auth_client(), knowledgebase_client() (+14 more)

### Community 26 - "Community 26"
Cohesion: 0.05
Nodes (11): _nerilio_fixture_pages(), Offline unit tests for scripts/scrape_snap.py (snap.de + nerilio.ai scraper)., A 5xx page must fail the whole run: the refresh pipeline deletes the entire, 404/410 means the page was genuinely removed: it drops out of the feed     (ind, A page that 301s to a foreign host must not inject third-party content into, A complete crawl exactly at the cap must succeed; only genuinely uncrawled, test_scrape_nerilio_aborts_on_network_error(), test_scrape_nerilio_aborts_on_server_error() (+3 more)
...
Cohesion: 0.04
Nodes (46): botConfigApi(), BotConfig, ActivityDetail, ChatAppRequest, ChatAppRequestContext, ChatAppRequestOverrides, ChatAppResponse, ChatAppResponseOrError (+38 more)

### Community 30 - "Community 30"
Cohesion: 0.07
Nodes (54): ChatbotUserOptions, getRakHistoryUser(), cancelChatbotUploadApi(), chatApi(), configApi(), deleteAllChatbotUploadedFilesApi(), deleteChatbotUploadedFileApi(), deleteChatHistoryApi() (+46 more)
...
Cohesion: 0.27
Nodes (29): buildInitialConversation(), buildInitialAssistantPair(), getHistorySourceBot(), clearChat(), createClientSessionId(), getConfig(), getCurrentSessionState(), getLastRealQuestion() (+21 more)

### Community 33 - "Community 33"
Cohesion: 0.08
Nodes (14): mock_retrieval_response_with_sharepoint(), mock_retrieval_response_with_sorting(), mock_retrieval_response_with_top_limit(), mock_speak_text_cancelled(), mock_speak_text_failed(), mock_speak_text_success(), MockAudio, MockAudioCancelled (+6 more)

### Community 34 - "Community 34"
Cohesion: 0.21
Nodes (7): HTMLParser, collapse_inline(), _MarkdownExtractor, normalize_href(), Resolve an anchor/image URL for markdown (absolute where possible), dropping, Convert a WordPress/Divi HTML body into GitHub-flavored markdown: headings,, Collapse all whitespace (including newlines) in an inline fragment to single

### Community 35 - "Community 35"
Cohesion: 0.02
Nodes (34): login_simple_chatbot(), messages_contains_text(), pop_citation_activity_details(), Any, test_assets_route_delegates_to_send_from_directory(), test_auth_setup_returns_payload(), test_canonical_chatbot_route_locks_framing_to_whitelist(), test_chat_handle_exception_contentsafety_streaming_chatbot_override() (+26 more)

### Community 36 - "Community 36"
Cohesion: 0.29
Nodes (7): get_public_id(), Return the committed public ID for a BUILT-IN chatbot route name, or None., test_embed_demo_page_renders_chatbot_options(), test_embed_route_serves_spa_with_injected_name_and_locked_csp(), test_embed_widget_config_returns_rules_with_cors(), test_internal_admin_embed_config_get_and_save(), test_route_name_resolves_anonymized_embed_referer()

### Community 37 - "Community 37"
Cohesion: 0.09
Nodes (22): Adding an OpenAI load balancer, Deploying with private endpoints, Enabling authentication, Enabling client-side chat history, Enabling cloud data ingestion, Enabling CORS for an alternate frontend, Enabling language picker, Enabling login and document level access control (+14 more)
...
Cohesion: 0.07
Nodes (56): get_file_acls(), Extract user and group IDs from ADLS Gen2 ACLs for a file.      Args:, EventGridEventStub, LogCaptureFixture, MonkeyPatch, Reload module without pytest env to trigger init warning path., Helper to set up mocks for get_file_acls tests., Test that get_file_acls extracts user OIDs with read permission. (+48 more)

### Community 42 - "Community 42"
Cohesion: 0.11
Nodes (21): cancelManagedUploadApi(), deleteManagedUploadedFileApi(), deleteManagedUploadedFilesApi(), listManagedUploadsApi(), ManagedUploadCreatedEntry, ManagedUploadEntry, ManagedUploadFailure, ManagedUploadListResponse (+13 more)

### Community 43 - "Community 43"
Cohesion: 0.02
Nodes (175): Path, get_registered_chatbot_names(), admin_page(), apply_saved_chatbot_prompt_override(), bot_config(), build_chat_model_deployments(), build_dynamic_chatbot_admin_payload(), build_embed_admin_payload() (+167 more)
...
Cohesion: 0.08
Nodes (37): module_label(), M7.1' -> 'Module 7.1' (learner-facing module heading)., _answer_module(), _drive_to_module10(), _FakeBlobManager, _log_turn(), Store the finalising turn with its [[SCORE]] but WITHOUT the boundary/completion, One request/response cycle against the real engine. Returns (messages, content, (+29 more)
...
Cohesion: 0.04
Nodes (57): buildPublishOneUrl(), getCitationLabel(), AnswerOptions(), AnswerOptionsProps, isListLayout(), ActivityDetailLike, ActivityStepMeta, activityTypeLabels (+49 more)
...
Cohesion: 0.09
Nodes (24): AsyncOpenAI, AsyncTokenCredential, Strategy, AsyncOpenAI, AsyncTokenCredential, BlobManager, DocumentAction, main() (+16 more)
...
Cohesion: 0.21
Nodes (23): Application, add_client_secret(), client_app(), create_application(), create_or_update_application_with_secret(), main(), GraphServiceClient, random_app_identifier() (+15 more)

### Community 67 - "Community 67"
Cohesion: 0.19
Nodes (20): Any, build_metadata_lines(), coerce_tags(), collect_tags(), extract_records(), looks_like_record_collection(), lowercase_key_map(), pick_text_field() (+12 more)
...
Cohesion: 0.10
Nodes (18): ABC, SearchManager, remove_existing_lemon_documents(), resolve_embedding_settings(), run(), check_search_service_connectivity(), Check if the search service is accessible by hitting the /ping endpoint., Script to setup cloud ingestion for Azure AI Search. (+10 more)
...
Cohesion: 0.04
Nodes (65): BlobManager, Any, SearchInfo, Any, BlobManager, SearchInfo, BlobManager, BlobManager (+57 more)

### Community 73 - "Community 73"
Cohesion: 0.13
Nodes (18): openStorageKey(), buildIframeSrc(), ChatbotWidgetApi, ChatbotWidgetConfig, close(), closePanel(), ensureIframe(), fetchRemoteConfig() (+10 more)

### Community 74 - "Community 74"
Cohesion: 0.10
Nodes (22): IO, archive_entry_name(), document_blob_name(), expand_feed_archive(), FeedArchive, FeedArchiveDocument, image_blob_name(), ImageDescriptionCache (+14 more)

### Community 75 - "Community 75"
Cohesion: 0.14
Nodes (27): parse(), Tests for the provisioned ("generic") bot JSON record parser.  The parser exists, Records shaped like a real website scrape.      Each record opens with that page, scraped_pages(), test_a_long_record_is_split_into_several_chunks_that_all_keep_the_record_metadata(), test_a_phrase_that_merely_recurs_in_prose_does_not_truncate_a_title(), test_a_single_object_document_uses_its_title_and_has_no_url(), test_a_title_shared_by_many_pages_is_still_used_as_the_title() (+19 more)
...
Cohesion: 0.07
Nodes (45): create_app(), get_openlit_llm_only_disabled_instrumentors(), ChatbotConfig, Check that this combo works correctly with prepdocs.py embedding service., Check that this combo works correctly with prepdocs.py embedding service., Check that this combo works correctly with prepdocs.py embedding service., Check that this combo works correctly with prepdocs.py embedding service., Check that this combo works correctly with prepdocs.py embedding service. (+37 more)

### Community 79 - "Community 79"
Cohesion: 0.14
Nodes (7): mock_vision_response(), MockResponse, MockAsyncOpenAI, MockChatCompletions, test_contentunderstanding_analyze(), test_multimodal_model_describer(), test_multimodal_model_describer_empty_response()
...
Cohesion: 0.07
Nodes (19): pivotItemDisabledStyle, Props, Props, Claim, Props, LayoutWrapper(), appServicesLogout(), AppServicesToken (+11 more)

### Community 82 - "Community 82"
Cohesion: 0.06
Nodes (35): value, value, value, value, value, value, value, value (+27 more)

### Community 83 - "Community 83"
Cohesion: 0.11
Nodes (39): ListFileStrategy, parse_file(), JsonParser, Concrete parser that can parse JSON into Page objects. A top-level object become, Class that splits pages into smaller chunks based on a max object length. It is, SimpleTextSplitter, Parses XML into retrieval-friendly sections by preserving hierarchy and splittin, XmlParser (+31 more)
...
Cohesion: 0.12
Nodes (24): looks_like_public_id(), True if ``value`` has the shape of a minted public ID (cheap pre-check, no looku, Resolve a public ID to a chatbot route name across BOTH built-in and dynamic bot, resolve_public_id_async(), FakeRecord, FakeRegistryStore, test_alias_public_test_maps_to_free(), test_builtin_ids_resolve_without_touching_the_registry() (+16 more)

### Community 86 - "Community 86"
Cohesion: 0.12
Nodes (8): datetime, format_utc(), InMemoryBlobManager, InMemoryBlobServiceClient, InMemoryContainerClient, test_empty_rules_clears_the_record(), test_missing_config_is_allow_all(), test_save_and_load_round_trip_normalizes_rules()
...
Cohesion: 0.07
Nodes (76): Any, Approach, BaseException, ChatbotRegistryRecord, ChatbotRegistryStore, FreeAuthStore, SimpleChatbotAuthStore, BlobManager (+68 more)

### Community 90 - "Community 90"
Cohesion: 0.10
Nodes (37): FreeAccount, build_account(), build_auth_store(), FreeAuthStore, Accounts registered before the trial window existed still expire 30 days after s, An expired account must not become an oracle for which emails are registered., The form stacks first/last above the company field, so the topmost gap must win., Every PendingFreeSignup rewrite must carry them, or the account is created witho (+29 more)

### Community 91 - "Community 91"
Cohesion: 0.09
Nodes (17): pivotItemDisabledStyle, Props, Claim, Props, appServicesLogout(), AppServicesToken, AuthSetup, checkLoggedIn() (+9 more)
...
Cohesion: 0.11
Nodes (30): Any, datetime, accumulate_turn(), add_to_histogram(), bucket_bounds(), bucket_index(), bucket_label(), bucket_start() (+22 more)

### Community 94 - "Community 94"
Cohesion: 0.09
Nodes (16): { getCurrentSession, isAuthenticated, login, logout }, { getCurrentSession, isAuthenticated, login, logout }, { getCurrentSession, isAuthenticated, login, logout }, { getCurrentSession, isAuthenticated, login, logout }, { getCurrentSession, isAuthenticated, login, logout }, { getCurrentSession, isAuthenticated, login, logout }, { getCurrentSession, isAuthenticated, login, logout }, { getCurrentSession, isAuthenticated, login, logout } (+8 more)

### Community 95 - "Community 95"
Cohesion: 0.06
Nodes (26): AnswerComponentProps, DefaultAnswer, makeAnswer(), stripAssessmentMarkers(), createBotAnswer(), Props, SpeechOutputAzure(), Answer (+18 more)

### Community 96 - "Community 96"
Cohesion: 0.16
Nodes (22): BlobListIterator, create_pdf_bytes(), login_simple_chatbot(), MockBlobClient, BytesIO, test_cancel_chatbot_upload_prevents_indexing(), test_chatbot_upload_file(), test_chatbot_upload_rejects_filename_conflict_with_builtin_demo_content() (+14 more)
...
Cohesion: 0.14
Nodes (14): Azure AI Search resource, Azure AI Vision resources, Azure App Service Plan and App Service resources, Azure Document Intelligence resource, Azure OpenAI, Azure Speech resource, Azure Storage Account, Openai.com OpenAI (+6 more)
...
Cohesion: 0.19
Nodes (14): hasAssessmentDoneMarker(), hasModuleFailMarker(), hasModulePassMarker(), parseProgressValue(), splitAssessmentBubbles(), useHistoryManager(), Chat(), getLemonUserScope() (+6 more)

### Community 102 - "Community 102"
Cohesion: 0.14
Nodes (20): BoilerplateIndex, build_boilerplate_index(), derive_title(), DynamicJsonPreparedDataset, estimate_tokens(), head_word_matches(), humanize_slug(), Record-oriented JSON parser for provisioned ("generic") chatbot knowledge bases. (+12 more)

### Community 103 - "Community 103"
Cohesion: 0.07
Nodes (27): dependencies, @azure/msal-browser, @azure/msal-react, dompurify, @fluentui/react, @fluentui/react-components, @fluentui/react-icons, framer-motion (+19 more)

### Community 104 - "Community 104"
Cohesion: 0.08
Nodes (50): Any, datetime, download_hyrox_assessment_visits_csv(), list_hyrox_assessment_visits(), Record one visit to the HYROX assessment bot (user id + timestamp) for the admin, Month summaries for the picker plus a capped preview of the selected month's row, The export: one CSV of user id + timestamp for a month (or every month)., record_hyrox_assessment_visit() (+42 more)
...
Cohesion: 0.14
Nodes (11): getPreferredSpeechSynthesisOutputFormat(), Props, SpeechOutputAzureButton(), clearPlaybackFallbackTimer(), closePlayer(), closeSynthesizer(), finishPlayback(), handlePlay() (+3 more)

### Community 109 - "Community 109"
Cohesion: 0.11
Nodes (19): 1. Endpoint, 2. Authentication, 3. Request envelope, 4. Operations, 5. `defaults` field reference, 6. Behavior & rules, 7. Examples, 8. Open items / roadmap (+11 more)

### Community 110 - "Community 110"
Cohesion: 0.16
Nodes (9): AutoBlobIndexer, normalize_prefix(), Return the search category for a blob.          In dynamic mode the category i, Whether a blob should be read as an archive package.          Extension first,, storageUrl prefix shared by every document mirrored out of one archive., Drop every search doc and mirrored blob belonging to one archive package., Index one archive package: several feed documents plus the images they reference, package_name_for_archive() (+1 more)
...
Cohesion: 0.26
Nodes (10): chatApi(), deleteChatHistoryApi(), deleteUploadedFileApi(), getChatHistoryApi(), getChatHistoryListApi(), getCitationFilePath(), getHeaders(), listUploadedFilesApi() (+2 more)

### Community 113 - "Community 113"
Cohesion: 0.18
Nodes (15): ExplodingCounter, FakeCounter, FakeRegistry, make_ctx(), make_record(), Tests for the number_sessions quota enforcement (Phase 2).  Covers the quota bra, Asserts the counter is never consulted (unlimited / built-in paths)., test_builtin_never_touches_either_store() (+7 more)
...
Cohesion: 0.20
Nodes (15): main(), ManageAcl, Any, SearchClient, Manually enable document level access control on a search index and manually set, run_server(), test_add_acl(), test_enable_acls_with_missing_fields() (+7 more)
...
Cohesion: 0.08
Nodes (32): 2026-07-01, `/admin/uploads`: category combobox + wire fhg/moodle/publishone custom parsers into managed uploads, Changes, Changes, Changes, Changes, Changes, Changes (+24 more)
...
Cohesion: 0.08
Nodes (20): pivotItemDisabledStyle, Props, Props, Claim, Props, isAuthenticated(), appServicesLogout(), AppServicesToken (+12 more)
...
Cohesion: 0.14
Nodes (11): URLSafeTimedSerializer, FreeAccount, FreeAuthStore, normalize_free_email(), PendingFreePasswordReset, PendingFreeSignup, Register a newly verified account as a HubSpot contact.          Runs last in, Grant an archived (expired) account another access window, counted from now. (+3 more)
...
Cohesion: 0.11
Nodes (20): Data Categorization (--category), Cloud Ingestion (Azure Functions Skills), Cloud Indexer Skillset Architecture, Local Ingestion (prepdocs.py), MD5 Hash Skip (incremental), Shaper Skill (consolidation), User Document Upload, Add Documents API + manageacl.py (+12 more)
...
Cohesion: 0.04
Nodes (71): Page, IO, Page, IO, Page, Any, IO, Page (+63 more)
...
Cohesion: 0.04
Nodes (97): AsyncTokenCredential, process_page_image(), Generate description, upload image, and optionally compute embedding for a figur, Generate a description for the provided image bytes if a describer is available., DocumentAnalysisParser, Concrete parser backed by Azure AI Document Intelligence that can parse many doc, build_file_processors(), Create a FigureProcessor based on feature flags.      Priority order:       1 (+89 more)

### Community 149 - "Community 149"
Cohesion: 0.05
Nodes (16): AnswerSynthesisActivity, EmbeddingUsage, datetime, QueryPlanningActivity, First-party LLM telemetry: the record codec, cost arithmetic, aggregation and th, Shaped like `openai.types.CreateEmbeddingResponse.Usage` -- note it has NEITHER, sample_rows(), SearchIndexActivity (+8 more)
...
Cohesion: 0.07
Nodes (21): pivotItemDisabledStyle, Props, Props, Claim, Props, appServicesLogout(), AppServicesToken, AuthSetup (+13 more)

### Community 158 - "Community 158"
Cohesion: 0.10
Nodes (18): adls_blob_manager(), blob_manager(), Test that BlobManager.download_blob returns None when download_response.properti, Test that AdlsBlobManager.download_blob returns None when a user tries to access, Test that AdlsBlobManager.download_blob works when a user has permission to acce, test_adls_download_blob_permission_denied(), test_adls_download_blob_with_permission(), test_create_container_upon_upload() (+10 more)
...
Cohesion: 0.14
Nodes (15): bensbergChatbot, BuiltinChatbotEntry, BuiltinChatbotsResponse, listBuiltinChatbotsApi(), compiledBuiltInEntries, DirectoryEntry, DynamicChatbotEntry, DynamicChatbotsResponse (+7 more)

### Community 165 - "Community 165"
Cohesion: 0.23
Nodes (11): recordAssessmentVisitApi(), chatApi(), deleteChatHistoryApi(), deleteUploadedFileApi(), getChatHistoryApi(), getChatHistoryListApi(), getCitationFilePath(), getHeaders() (+3 more)
...
Cohesion: 0.29
Nodes (7): variables, abbrs, deploymentContainerName, hostId, resourceToken, runtimeStorageName, runtimeStorageRoles
...
Cohesion: 0.15
Nodes (15): Managed Identity & RBAC, Deploy With Existing Azure Resources, RBAC Cross-RG Caveat, Private Endpoints Deployment Guide, Private Access Environment Variables, VPN Gateway (VpnGw2), Deployment Troubleshooting, azd monitor Dashboard (+7 more)

### Community 202 - "Community 202"
Cohesion: 0.24
Nodes (7): Any, ChatCompletionMessageParam, Build a single system message. Use for simple prompts like query rewrite., Build a single user message with optional images.          Args:, Build a full conversation with system, history, and user message.          Arg, ChatCompletionSystemMessageParam, ChatCompletionUserMessageParam

### Community 203 - "Community 203"
Cohesion: 0.24
Nodes (11): askApi(), chatApi(), deleteChatHistoryApi(), deleteUploadedFileApi(), getChatHistoryApi(), getChatHistoryListApi(), getCitationFilePath(), getHeaders() (+3 more)
...
Cohesion: 0.11
Nodes (32): Any, datetime, day_of(), decode_metadata(), decode_prompt_preview(), decode_step_digest(), encode_metadata(), encode_prompt_preview() (+24 more)

### Community 210 - "Community 210"
Cohesion: 0.08
Nodes (5): InternalBasicAuthGate(), internalChatbot, InternalLayout(), LayoutWrapper(), LayoutWrapper()
...
Cohesion: 0.13
Nodes (13): fake_hubspot(), HubSpot contact creation for verified Free Bot signups.  These exercise the real, A revoked token or a renamed property must never surface as a signup error., HubSpot answers 409 for a known email; the signup is not the authority on that c, An unbounded HubSpot error body must not flood the log., Serve `handler` at the contacts path and yield its URL., test_a_duplicate_contact_is_left_untouched(), test_a_hanging_hubspot_gives_up_instead_of_holding_the_signup_open() (+5 more)
...
Cohesion: 0.10
Nodes (23): Any, datetime, TurnRecord, PriceTable, clamp_day_range(), day_range(), parse_cursor(), Blob-backed persistence for turn records, plus the range planner the dashboard q (+15 more)
...
Cohesion: 0.42
Nodes (11): CompletedProcess, configure_event_subscription(), configure_single_subscription(), event_subscription_exists(), load_default_azd_env(), required_env(), resolve_cli_executable(), resolve_function_app_name() (+3 more)

### Community 223 - "Community 223"
Cohesion: 0.17
Nodes (12): Semantic Ranker, Free Trial Deployment Notes, Switch to Free App Service (F1), Disable vector search (USE_VECTORS=false), Low-Cost Deployment Guide, Free Azure AI Search tier (no semantic ranker/managed identity), Copilot Chat Debug Mode, Local Development Guide (+4 more)

### Community 226 - "Community 226"
Cohesion: 0.17
Nodes (12): devDependencies, prettier, rollup-plugin-visualizer, @types/dom-speech-recognition, @types/dompurify, @types/node, @types/react, @types/react-dom (+4 more)
...
Cohesion: 0.25
Nodes (3): EmailMessage, build_code_email_html(), get_frontend_logo_asset_path()

### Community 231 - "Community 231"
Cohesion: 0.07
Nodes (37): Quart, TelemetryStore, drive_stream(), How telemetry attaches to the two chat routes.  The invariant that matters most, Shaped like `openai.types.chat.ChatCompletionChunk` as the loop consumes it., The real `run_with_streaming`, with only the collaborators it touches stubbed ou, Run one streamed turn and hand back its recorded steps., The regression test for a short, token-less answer step and a wall of "unaccount (+29 more)
...
Cohesion: 0.20
Nodes (10): 2026-06-26, Changes, Changes, Changes, Decisions, Decisions, Decisions, Embed widget: per-bot launcher icon color; hyrox black bubble + yellow icon (+2 more)
...
Cohesion: 0.26
Nodes (5): FreeAuthError, FreeVerificationChallenge, Refuse a signup for an email that already has an account.          An expired, build_secret_hash(), validate_password_requirements()

### Community 243 - "Community 243"
Cohesion: 0.11
Nodes (18): contentVersion, type, value, name, templateHash, version, metadata, _generator (+10 more)

### Community 244 - "Community 244"
Cohesion: 0.11
Nodes (19): System Architecture Diagram, ChatReadRetrieveRead Approach, Deployment Options (Container Apps vs App Service), RAG Chat Application Architecture, Architecture Diagram, Azure Services Integration, Backend (Python), Chat Query Flow (+11 more)
...
Cohesion: 0.11
Nodes (31): Any, answer_step_started_at(), clamp_text(), clear_current(), close_answer_step(), discard_answer_step(), env_flag(), get_current() (+23 more)
...
Cohesion: 0.12
Nodes (21): Any, TokenCounts, The only write route on the dashboard. Editing a price never rewrites history --, save_telemetry_pricing(), compare_currencies(), CostEstimate, load_env_price_table(), ModelPrice (+13 more)
...
Cohesion: 0.18
Nodes (3): BaseMetric, AnyCitationMetric, CitationsMatchedMetric

### Community 257 - "Community 257"
Cohesion: 0.20
Nodes (10): Additional security measures, Azure AI Search, Azure App Service, Azure Container Apps, Azure resource configuration, Azure Storage, Evaluation, Load testing (+2 more)

### Community 258 - "Community 258"
Cohesion: 0.22
Nodes (8): Analysis Process, Constraints, Example Categories to Target, Issue Triager, Output Format, Primary Objective, Success Criteria, Task Requirements

### Community 259 - "Community 259"
Cohesion: 0.15
Nodes (13): 2026-06-24, Bensberg bot: rename display name from Lemon®AID to Bensberg, Changes, Changes, Changes, Changes, Decisions, Decisions (+5 more)
...
Cohesion: 0.22
Nodes (9): Hot reloading frontend and backend files, RAG chat: Local development of chat app, Running development server from the command line, Using a local OpenAI-compatible API, Using Copilot Chat Debug Mode, Using llamafile server, Using Ollama server, Using VS Code "Development" task (+1 more)

### Community 265 - "Community 265"
Cohesion: 0.22
Nodes (8): Any log messages given by the failure, azd version?, Expected/desired behavior, Mention any other details that might be useful, Minimal steps to reproduce, OS and Version?, This issue is for a: (mark with an `x`), Versions

### Community 266 - "Community 266"
Cohesion: 0.22
Nodes (8): API Endpoint, Example Replies, GitHub PR Inline Reply Skill, Notes, Resolving Conversations, Using gh CLI, When to use, Workflow

### Community 267 - "Community 267"
Cohesion: 0.22
Nodes (8): Bicep best-practices, General, Glossary, Resources, Rules, Security, Syntax, Types
...
Cohesion: 0.13
Nodes (18): FakeBlobManager, BlobListEntry, datetime, HYROX assessment visit tracking + the admin CSV export.  The bot pings ``/hyro, Records uploads and serves them back from list_blobs, like the real overwrite=Tr, record(), test_a_recorded_visit_is_readable_back_out_of_the_listing(), test_each_ping_is_its_own_blob_so_concurrent_visits_never_overwrite_each_other() (+10 more)
...
Cohesion: 0.12
Nodes (23): download_telemetry_csv(), format_micros_for_csv(), get_telemetry_filters(), get_telemetry_summary(), list_telemetry_requests(), (from_day, to_day, error). `from`/`to` win over `range`; both are inclusive UTC, CSV per facet. Composition is OR within a facet and AND across facets -- the rul, `all` only applies when no explicit `from`/`to` was given -- those always win. (+15 more)
...
Cohesion: 0.09
Nodes (30): Any, Any, get_content_filter_message(), load_chatbot_content_filter_messages(), normalize_content_filter_language(), normalize_content_filter_messages(), normalize_chatbot_name(), format_as_ndjson() (+22 more)

### Community 283 - "Community 283"
Cohesion: 0.40
Nodes (4): arrowParens, printWidth, tabWidth, trailingComma
...
Cohesion: 0.13
Nodes (19): ADMIN_TABS, AdminLayout(), AdminShellContext, AdminShellContextValue, useAdminShell(), EmbedDemoTab(), ChatbotDirectory(), FreeUsersPage() (+11 more)

### Community 294 - "Community 294"
Cohesion: 0.12
Nodes (16): 2026-08-17, `/bbsa`: hands-free conversation mode for the live avatar, `/bbsa`: live chat avatar (Azure real-time TTS avatar, Austrian German), `/bbsa`: speak-answer button now uses `de-AT-JonasNeural` (per-bot voice, not deployment-wide), `/bbsa`: the live-avatar control is now a proper launcher, not an icon button, Changes, Changes, Changes (+8 more)
...
Cohesion: 0.10
Nodes (30): Any, build_document_components(), extract_document(), process_document(), Azure Search Custom Skill: Extract document content      Input format (single, Process a single document: download, parse, extract figures, upload images, process_figure_request(), Entrypoint for Azure Search custom skill calls. (+22 more)
...
Cohesion: 0.07
Nodes (36): Any, get_required_string_field(), get_string_list_field(), is_bbsa_payload(), prepare_bbsa_dataset(), validate_bbsa_payload(), build_bbsa_payload(), build_bbsa_record() (+28 more)
...
Cohesion: 0.10
Nodes (18): pivotItemDisabledStyle, Props, Claim, Props, getCurrentSession(), appServicesLogout(), AppServicesToken, AuthSetup (+10 more)
...
Cohesion: 0.15
Nodes (8): IO, Dialect, CsvParser, Parse CSV-like tabular files into one Page per logical row.      Goals:     - Ha, test_csvparser_empty_file(), test_csvparser_handles_semicolon_and_multiline_fields_with_metadata(), test_csvparser_multiple_rows_keep_row_boundaries_and_offsets(), test_csvparser_single_row_renders_labeled_record()

### Community 389 - "Community 389"
Cohesion: 0.25
Nodes (8): Deploy an evaluation model, Evaluate multimodal RAG answers, Evaluating the RAG answer quality, Generate ground truth data, Review the evaluation results, Run bulk evaluation, Run bulk evaluation on a PR, Setup the evaluation environment
...
Cohesion: 0.10
Nodes (23): login_internal_admin(), make_dynamic_record(), test_builtin_chatbots_listing_reports_the_settings_chat_would_use(), test_builtin_chatbots_listing_resolves_the_public_test_alias(), test_dynamic_chatbots_listing_backfills_a_missing_public_id(), test_dynamic_chatbots_listing_honors_a_deployed_provisioned_model(), test_dynamic_chatbots_listing_includes_stopped_bots_and_effective_models(), test_embed_route_locks_framing_to_a_provisioned_bots_whitelist() (+15 more)
...
Cohesion: 0.12
Nodes (22): assistant_texts(), _completed_state(), derive_turn_state(), parse_asked_ids(), _parse_attrs(), parse_new_score(), parse_points(), prior_module_results() (+14 more)
...
Cohesion: 0.18
Nodes (11): deleteFreeUserApi(), FreeAdminUser, FreeAdminUsersResponse, FreeDeleteUserResponse, FreeReactivateUserResponse, FreeResetPasswordResponse, listFreeUsersApi(), parseErrorMessage() (+3 more)

### Community 406 - "Community 406"
Cohesion: 0.16
Nodes (7): Chat(), EMPTY_REASONING_EFFORT_OPTIONS, getLegacyReasoningEffortOptions(), GPT_5_4_REASONING_EFFORT_OPTIONS, GPT_5_REASONING_EFFORT_OPTIONS, SourceBotOption, InternalLayoutOutletContext

### Community 408 - "Community 408"
Cohesion: 0.14
Nodes (14): 2026-07-28, azd envs: `agentic-retrieval-nerilio` is prod, `agentic-retrieval-test` mirrors it, Changes, Changes, Changes, Changes, Decisions, Decisions (+6 more)
...
Cohesion: 0.09
Nodes (32): BarLine, Bars(), BarSeries, BarsProps, MARGIN, ChartFrame(), ChartFrameProps, ChartTable (+24 more)

### Community 411 - "Community 411"
Cohesion: 0.18
Nodes (12): EmbedConfigEntry, EmbedConfigMutationResponse, EmbedConfigResponse, getEmbedConfigApi(), parseErrorMessage(), saveEmbedConfigApi(), EmbedSnippetModal(), EmbedSnippetModalProps (+4 more)
...
Cohesion: 0.17
Nodes (7): DataLakeDirectoryClient, Ensures that a directory path exists and has proper permissions.         Create, Returns the standardized path for storing document images.          Args:, Uploads an image from a document to ADLS in a directory structure:         {use, Downloads a blob from Azure Data Lake Storage.          Args:             blo, Deletes a file from the user's directory in ADLS and any associated image direct, Lists the uploaded documents for the given user.         Only returns files dir
...
Cohesion: 0.08
Nodes (16): AioHttpTransportResponse, mock_blob_container_client(), mock_user_directory_client(), MockAiohttpClientResponse, MockAiohttpClientResponse404, MockBlob, MockBlobClient, MockDirectoryClient (+8 more)

### Community 430 - "Community 430"
Cohesion: 0.09
Nodes (33): BytesIO, datetime, build_possible_citations_prompt(), get_chatbot_citation_target(), get_chatbot_config(), get_chatbot_prompt_mode(), get_language_name(), load_all_chatbot_configs() (+25 more)

### Community 431 - "Community 431"
Cohesion: 0.23
Nodes (13): File, Section, build_dynamic_json_sections_if_applicable(), DynamicJsonPreparedDocument, load_dynamic_json_payload(), prepare_dynamic_json_sections(), prepared_document_to_section(), Read the file as JSON, tolerating a UTF-8 BOM.      ``hyroxjson.load_json_payloa (+5 more)

### Community 432 - "Community 432"
Cohesion: 0.11
Nodes (29): formatDay(), formatExactCount(), formatRequestCount(), CostsTabProps, OverviewTabProps, RequestsTab(), downloadTelemetryCsvApi(), getJson() (+21 more)
...
Cohesion: 0.15
Nodes (13): 2026-07-29, Changes, Changes, Changes, Changes, Decisions, Decisions, Decisions (+5 more)
...
Cohesion: 0.15
Nodes (18): BaseException, datetime, TokenCounts, TurnRecord, begin_turn(), finalize(), new_trace_id(), price_record() (+10 more)

### Community 446 - "Community 446"
Cohesion: 0.13
Nodes (17): generate_ground_truth_ragas(), get_azure_credential(), get_search_documents(), _current_question_interaction(), is_give_up_or_meta(), _normalize_for_match(), normalize_give_up_text(), paragraph_reproduces_pool_question() (+9 more)

### Community 447 - "Community 447"
Cohesion: 0.08
Nodes (45): AsyncOpenAI, AsyncTokenCredential, BlobManager, Namespace, BlobManager, FeedArchiveOptions, FileProcessor, SearchManager (+37 more)

### Community 456 - "Community 456"
Cohesion: 0.14
Nodes (24): recent_days(), call(), The admin-gated `/internal-admin/telemetry/*` routes.  Driven through a bare Q, The regression test for "All time shows no data".      `all` used to resolve t, run(), test_a_bad_range_is_rejected_with_a_message_not_a_500(), test_a_forged_blob_reference_is_refused(), test_a_price_edit_with_nothing_valid_in_it_is_rejected() (+16 more)
...
Cohesion: 0.12
Nodes (4): FakeBlob, FakeBlobClient, FakeContainer, FakeDownloader

### Community 478 - "Community 478"
Cohesion: 0.19
Nodes (18): AsyncTokenCredential, AutoBlobIndexer, Namespace, ArgumentParser, bot_folder_for(), build_arg_parser(), build_credential(), build_indexer() (+10 more)
...
Cohesion: 0.29
Nodes (7): 2026-07-10, Changes, Changes, Decisions, Decisions, Removed hairline border from the embed widget popup panel, Snap bot welcome message rebrand to "nerilio"
...
Cohesion: 0.13
Nodes (13): grant_application_admin_consent(), GrantDefinition, SimpleNamespace, OpenLitAttributeRecorder, test_chat_adds_openlit_chatbot_attributes(), test_chat_stream_keeps_openlit_chatbot_attributes_active_while_streaming(), test_internal_chat_adds_openlit_route_and_source_attributes(), FakeOAuthGrant (+5 more)
...
Cohesion: 0.25
Nodes (15): datetime, describe_account_expiry(), format_utc(), FreeAccountExpiry, is_account_expired(), parse_utc(), parse_utc_or_none(), The moment a Free Bot account loses access.      A stored ``expires_at`` alway (+7 more)
...
Cohesion: 0.14
Nodes (11): StepRecord, add_step(), A step that has started but not finished.      Exists because the final answer c, Record an already-measured step. Used for the agentic activity records, whose du, StepHandle, `completion` ALREADY CONTAINS `reasoning`, and `prompt` already contains `cached, First present numeric attribute (or mapping key) among `names`, else 0., Read an OpenAI usage object without caring which one it is.      A chat comple (+3 more)
...
Cohesion: 0.18
Nodes (15): key_point_count(), module_of(), How many required key points question ``number`` has (== expected length of the, The module key for question ``number`` ("" if unknown)., merge_best_verdicts(), normalize_score(), An all-zero verdict for ``question_id`` — the only defensible score when the lea, Per-key-point best of two verdicts for the same question — the "better of the tw (+7 more)
...
Cohesion: 0.18
Nodes (23): Any, AsyncOpenAI, Namespace, Path, assemble_index_markdown(), assemble_page_markdown(), build_slug_map(), load_records() (+15 more)
...
Cohesion: 0.11
Nodes (18): 2026-07-04, 2026-08-18, 2026-08-19, bbsa live avatar: a transient network blip no longer ends the session mid-answer, bbsa: live-avatar control moved into the composer, panel opens full screen, Changes, Changes, Changes (+10 more)

### Community 526 - "Community 526"
Cohesion: 0.67
Nodes (3): datetime, format_utc(), Blob-backed store for dynamically provisioned chatbots.  This is the runtime sou

### Community 749 - "Community 749"
Cohesion: 0.33
Nodes (5): Committing the change, Fixer Mode Instructions, Local server setup, Making the PR, Running Python scripts

### Community 753 - "Community 753"
Cohesion: 0.25
Nodes (13): Any, activity_as_dict(), classify_activity(), normalize_type(), Reading the agentic-retrieval activity records into telemetry steps.  This clo, Close the parent retrieve step, then add one child step per activity record., (step name, step type) for one activity record.      Falls back to a generic s, Try each name on the object and on its `as_dict()` form, in both snake and camel (+5 more)
...
Cohesion: 0.33
Nodes (6): Checking Azure Monitor for errors, Checking the app logs for errors, Checking the deployment logs for errors, Configuring log levels, Debugging failed Azure App Service deployments, RAG chat: Debugging the app on App Service

### Community 767 - "Community 767"
Cohesion: 0.33
Nodes (5): Code quality checklist, Does this introduce a breaking change?, Does this require changes to learn.microsoft.com docs?, Purpose, Type of change
...
Cohesion: 0.05
Nodes (79): Any, _assistant_index_that_asked(), _backend_owned_prose_keys(), build_result_payload(), build_session_log_record(), build_state_injection(), compute_tally(), cut_premature_ending() (+71 more)
...
Cohesion: 0.16
Nodes (27): Any, get_required_string_field(), get_string_list_field(), is_snap_payload(), normalize_brand_casing(), prepare_snap_dataset(), Rewrite known SNAP brand tokens to their canonical casing (whole-word, case-inse, validate_snap_payload() (+19 more)
...
Cohesion: 0.40
Nodes (5): Azure DevOps, Configuring continuous deployment, GitHub actions, How does `azd up` work?, RAG chat: Deploying with the Azure Developer CLI

### Community 1248 - "Community 1248"
Cohesion: 0.40
Nodes (5): Before you begin, Compatibility with other features, Deployment steps for private access, Environment variables controlling private access, RAG chat: Deploying with private access

### Community 1249 - "Community 1249"
Cohesion: 0.40
Nodes (5): Customizing the traces, Dashboard, Failures, Performance, RAG chat: Monitoring with Application Insights

### Community 1250 - "Community 1250"
Cohesion: 0.40
Nodes (5): Deployment, Prerequisites, RAG chat: Using reasoning models, Supported Models, Using the feature

### Community 1255 - "Community 1255"
Cohesion: 0.40
Nodes (5): Deploy an Azure AI project, Evaluating RAG answer safety, Resources, Review the safety evaluation results, Simulate and evaluate adversarial users
...
Cohesion: 0.22
Nodes (9): timeZoneLabel(), downloadHyroxVisitsCsvApi(), HyroxVisitMonth, HyroxVisitRow, HyroxVisitsResponse, listHyroxVisitsApi(), parseErrorMessage(), HyroxVisitsPage() (+1 more)

### Community 1261 - "Community 1261"
Cohesion: 0.25
Nodes (5): main(), Test script for Azure AI Search elevated read permissions. This script verifies, SearchIndexClient, MonkeyPatch, test_main_passes_search_key_and_closes_credential()

### Community 1264 - "Community 1264"
Cohesion: 0.36
Nodes (10): Any, Path, load_scraped_payload(), load_state(), log(), main(), Run a sub-step, streaming its output live; raise SystemExit on failure., Read + lightly validate data/snap.json after scraping, before any destructive st (+2 more)
...
Cohesion: 0.14
Nodes (13): Bucket granularity, Cost, History, and what the dashboard could not inherit, LLM telemetry and the `/admin/telemetry` dashboard, Operating, Privacy, Ranges, Retention (+5 more)
...
Cohesion: 0.06
Nodes (89): File, Section, File, Section, Any, File, Section, Element (+81 more)
...
Cohesion: 0.20
Nodes (10): 2026-07-02, Changes, Changes, Changes, Decisions, Decisions, Decisions, HYROX assessment — course rename ("Mastering Performance") + welcome pause note + post-pass copy (+2 more)
...
Cohesion: 0.08
Nodes (25): 2026-07-03, `/admin/uploads`: managed uploads list is now blob-driven — script/feed-ingested files show up and stay in sync, Changes, Changes, Changes, Changes, Changes, Changes (+17 more)
...
Cohesion: 0.16
Nodes (13): CustomUvicornWorker, delete_documents_by_category function, delete_documents_by_category main, Gunicorn Config, load_azd_env, load_azd_env(), Get path to current azd env file and load file using python-dotenv, main.py entry (+5 more)

### Community 1396 - "Community 1396"
Cohesion: 0.14
Nodes (14): Client-side chat history (IndexedDB), Persistent chat history (Cosmos DB), Media description (Azure Content Understanding), CORS for alternate frontend, Optional Features Guide, Language picker / i18n, Using local PDF/HTML parsers, Search service query rewriting (+6 more)

### Community 1399 - "Community 1399"
Cohesion: 0.32
Nodes (12): Any, Path, describe_change(), load_scraped_payload(), load_state(), log(), main(), Log which part of the watermark moved, so a refresh is explainable after the fac (+4 more)

### Community 1400 - "Community 1400"
Cohesion: 0.29
Nodes (11): chatApi(), deleteChatHistoryApi(), deleteUploadedFileApi(), getChatHistoryApi(), getChatHistoryListApi(), getCitationFilePath(), getHeaders(), listUploadedFilesApi() (+3 more)
...
Cohesion: 0.22
Nodes (9): readStoredSession(), sizeStorageKey(), addResizeHandles(), attachResize(), createWidget(), readStoredOpen(), readStoredSize(), styleSheet() (+1 more)

### Community 1439 - "Community 1439"
Cohesion: 0.28
Nodes (4): Answer(), Layout(), useBotConfig(), setGlobalOpenRecentChats()
...
Cohesion: 0.12
Nodes (16): 2026-08-20, `/admin/hyrox-visits`: timestamps read in German time, not UTC, Audit: six defects found across the telemetry dashboard, five fixed, Changes, Decisions, First-party LLM telemetry, and the `/admin/telemetry` dashboard that replaces OpenLIT, Fix: "All time" showed no data on any tab, Fix: the by-chatbot Latency measure printed a request count instead of a latency (+8 more)

### Community 1463 - "Community 1463"
Cohesion: 0.22
Nodes (9): On a completed assessment the response carries the hidden [[DONE]] marker, so th, _hyrox_chat_response(), A non-streaming /chat response body for the HYROX assessment bot (forced non-str, On a passed completion the response carries the hidden [[DONE]] and [[PROGRESS]], On a failed completion the input is still removed, but the learner is offered an, Contrast: a normal mid-assessment turn (graded answer + the next question chaine, test_hyrox_assessment_failed_offers_restart(), test_hyrox_assessment_hides_input_when_completed() (+1 more)

### Community 1465 - "Community 1465"
Cohesion: 0.24
Nodes (8): FilterBarProps, MultiSelectProps, GRANULARITY_OPTIONS, PAGE_SIZE_OPTIONS, PATH_LABELS, RANGE_OPTIONS, STATUS_OPTIONS, TelemetryQueryState
...
Cohesion: 0.29
Nodes (7): 2026-08-01, `/bbsa`: fixed the 2px page scrollbar the navbar rule was causing, `/bbsa`: speech enabled, and the chat chrome switched from publishone's to lemon's, Changes, Changes, Decisions, Decisions
...
Cohesion: 0.40
Nodes (5): live_server_url(), live_server_url_history(), Live server with browser (IndexedDB) chat history enabled — required to exercise, Make requests to provided url until it responds without error., wait_for_server_ready()
...
Cohesion: 0.67
Nodes (3): normalize_record_text(), Make scraped/exported text searchable without changing its wording.      Only in, test_normalize_record_text_does_not_change_wording()

### Community 1531 - "Community 1531"
Cohesion: 0.22
Nodes (6): _FakeVisitBlobManager, Stands in for the global BlobManager: keeps uploads in memory and lists them bac, test_hyrox_visit_ping_ignores_anything_that_is_not_a_lemon_launch(), test_hyrox_visit_ping_ignores_local_runs(), test_hyrox_visit_ping_records_a_lemon_launch_without_a_session(), test_hyrox_visits_admin_lists_months_and_exports_csv()
...
Cohesion: 0.40
Nodes (4): get_application(), GraphServiceClient, test_authentication_enabled(), main()

### Community 1631 - "Community 1631"
Cohesion: 0.50
Nodes (3): Accomodate for Azure Container Apps restrictions, Accomodate for low OpenAI quotas, RAG chat: Deploying with a free trial account
...
Cohesion: 0.50
Nodes (3): AsyncTokenCredential, AzureKeyCredential, Initializes the command          Parameters         ----------         servi

### Community 2016 - "Community 2016"
Cohesion: 0.10
Nodes (32): Parses simple text into a Page object., TextParser, build_request(), Any, Test text processor returns error when settings not initialized., Test text processor handles empty sections., Test text processor logs warning when embeddings requested but not initialized., Test text processor skips empty chunks. (+24 more)
...
## Knowledge Gaps
- **2798 isolated node(s):** `timezone`, `ChatCompletionSystemMessageParam`, `ChatCompletionUserMessageParam`, `ChatCompletionMessageParam`, `ChatCompletionToolParam` (+2793 more)
...
- **Why does `BlobManager` connect `Community 10` to `Community 3`, `Community 136`, `Community 8`, `Community 14`, `Community 526`, `Community 16`, `Community 146`, `Community 148`, `Community 24`, `Community 158`, `Community 31`, `Community 43`, `Community 430`, `Community 1841`, `Community 305`, `Community 56`, `Community 447`, `Community 63`, `Community 70`, `Community 72`, `Community 83`, `Community 86`, `Community 89`, `Community 478`, `Community 229`, `Community 110`, `Community 239`, `Community 508`, `Community 1277`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `TelemetryStore` connect `Community 215` to `Community 231`, `Community 1703`, `Community 85`, `Community 149`, `Community 469`, `Community 248`, `Community 89`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `File` connect `Community 10` to `Community 0`, `Community 2`, `Community 3`, `Community 8`, `Community 146`, `Community 24`, `Community 415`, `Community 41`, `Community 431`, `Community 305`, `Community 307`, `Community 56`, `Community 63`, `Community 447`, `Community 67`, `Community 70`, `Community 198`, `Community 72`, `Community 1229`, `Community 83`, `Community 89`, `Community 2016`, `Community 97`, `Community 102`, `Community 110`, `Community 1277`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Are the 231 inferred relationships involving `BlobManager` (e.g. with `Any` and `Approach`) actually correct?**
  _`BlobManager` has 231 INFERRED edges - model-reasoned connections that need verification._
- **Are the 158 inferred relationships involving `File` (e.g. with `Any` and `Approach`) actually correct?**
  _`File` has 158 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `Wraps an exporter and only forwards LLM-related spans.`, `The real app object behind the `current_app` proxy.      Needed because the stre`, `Open the per-request telemetry envelope and attach whatever identity is already` to the rest of the system?**

# Graph Report - agentic-retrieval  (2026-07-10)

## Corpus Check
- 1702 files · ~2,315,959 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10970 nodes · 19468 edges · 1861 communities (1270 shown, 591 thin omitted)
- Extraction: 80% EXTRACTED · 20% INFERRED · 0% AMBIGUOUS · INFERRED: 3832 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c67cd5b4`
...
## Communities (1861 total, 591 thin omitted)
...
Cohesion: 0.06
Nodes (50): OpenAIEmbeddings, SearchInfo, AsyncTokenCredential, AzureKeyCredential, build_default_semantic_search(), Class to manage a search service. It can create indexes, and update or remove se, Creates one or more Knowledge Bases in the search index based on desired knowled, SearchManager (+42 more)
...
Cohesion: 0.04
Nodes (82): 2026-06-30, 2026-07-01, `/admin/uploads`: category combobox + wire fhg/moodle/publishone custom parsers into managed uploads, Beautiful global tooltip restyle (all bots), Changes, Changes, Changes, Changes (+74 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (104): Any, AsyncTokenCredential, SearchInfo, Namespace, AsyncOpenAI, AsyncTokenCredential, Namespace, AsyncOpenAI (+96 more)
...
Cohesion: 0.07
Nodes (21): Props, Props, Props, bensbergChatbot, cbtxChatbot, root, router, LayoutWrapper() (+13 more)
...
Cohesion: 0.04
Nodes (92): admin_page(), apply_saved_chatbot_prompt_override(), bot_config(), build_chat_model_deployments(), build_simple_auth_required_response(), cancel_chatbot_upload(), cancel_managed_upload(), chat() (+84 more)
...
Cohesion: 0.04
Nodes (128): ABC, IO, Page, IO, Page, Any, IO, Page (+120 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (28): SearchManager, BlobManager, Path, SearchManager, remove_existing_hyrox_documents(), resolve_embedding_settings(), run(), close_clients() (+20 more)
...
Cohesion: 0.10
Nodes (25): main(), ManageAcl, Any, AsyncTokenCredential, AzureKeyCredential, SearchClient, Manually enable document level access control on a search index and manually set, Initializes the command          Parameters         ----------         servi (+17 more)
...
Cohesion: 0.08
Nodes (30): BlobManager, datetime, Path, URLSafeTimedSerializer, delete_free_admin_user(), embed_demo(), format_utc(), FreeAccount (+22 more)
...
Cohesion: 0.12
Nodes (27): Any, ChatbotRegistryRecord, build_bot_config_payload(), derive_chatbot_mode(), language_label_to_code(), map_language_keyed(), map_language_list(), Map a dynamic chatbot's registry record onto the runtime config its frontend nee (+19 more)
...
Cohesion: 0.06
Nodes (70): AssessmentQuestion, get_question(), is_last_module(), key_point_count(), max_points(), module_index(), module_label(), module_max_points() (+62 more)

### Community 53 - "Community 53"
Cohesion: 0.09
Nodes (16): generate_ground_truth_ragas(), get_azure_credential(), get_search_documents(), main(), Test script for Azure AI Search elevated read permissions. This script verifies, SearchIndexClient, test_search_results_filtering_by_scores(), test_search_results_query_rewriting() (+8 more)
...
Cohesion: 0.04
Nodes (52): buildPublishOneUrl(), getCitationLabel(), AnswerOptions(), AnswerOptionsProps, isListLayout(), ActivityDetailLike, ActivityStepMeta, activityTypeLabels (+44 more)
...
Cohesion: 0.05
Nodes (40): 2026-05-26, 2026-06-02, 2026-06-03, 2026-06-04, 2026-06-05, 2026-06-11, 2026-06-23, 2026-06-29 (+32 more)

### Community 70 - "Community 70"
Cohesion: 0.06
Nodes (16): AioHttpTransportResponse, mock_retrieval_response_with_sharepoint(), mock_retrieval_response_with_sorting(), mock_speak_text_cancelled(), mock_speak_text_failed(), mock_speak_text_success(), MockAiohttpClientResponse, MockAiohttpClientResponse404 (+8 more)
...
Cohesion: 0.10
Nodes (31): AsyncOpenAI, AsyncTokenCredential, Strategy, SearchIndexerSkillset, AsyncOpenAI, AsyncTokenCredential, BlobManager, DocumentAction (+23 more)

### Community 75 - "Community 75"
Cohesion: 0.16
Nodes (13): Any, AsyncTokenCredential, AzureKeyCredential, BaseBlobManager, ImageEmbeddings, AsyncOpenAI, AsyncTokenCredential, MediaDescriber (+5 more)
...
Cohesion: 0.10
Nodes (29): Any, BytesIO, Any, get_content_filter_message(), load_chatbot_content_filter_messages(), normalize_content_filter_language(), normalize_content_filter_messages(), normalize_chatbot_name() (+21 more)
...
Cohesion: 0.09
Nodes (63): Any, ChatbotRegistryRecord, ChatbotRegistryStore, FreeAuthStore, SimpleChatbotAuthStore, BlobManager, Any, BlobManager (+55 more)
...
Cohesion: 0.06
Nodes (36): mock_blob_container_client(), mock_user_directory_client(), MockBlob, MockBlobClient, MockDirectoryClient, MockFileClient, login_simple_chatbot(), test_content_file_category_prefixed_blob_found() (+28 more)
...
Cohesion: 0.12
Nodes (20): build_embed_admin_payload(), embed_widget_config(), get_chatbot_embed_config_store(), get_internal_admin_embed_config(), save_internal_admin_embed_config(), generate_public_id(), is_embeddable(), main() (+12 more)

### Community 102 - "Community 102"
Cohesion: 0.11
Nodes (53): Element, File, FileProcessor, Section, Element, IO, Page, append_tag() (+45 more)
...
Cohesion: 0.07
Nodes (31): process_page_image(), Generate description, upload image, and optionally compute embedding for a figur, assert_image_equal(), Fixture for a sample ImageOnPage object used across multiple tests., Test ImageOnPage.from_skill_payload when bytes_base64 is not provided., Test ImageOnPage.from_skill_payload with invalid page_num., Test ImageOnPage.from_skill_payload with invalid bbox., sample_image() (+23 more)
...
Cohesion: 0.11
Nodes (13): BlobManager, datetime, list_uploaded(), Lists the uploaded documents for the current user.     Only returns files direc, ChatbotPromptStore, format_utc(), InMemoryBlobManager, InMemoryBlobServiceClient (+5 more)
...
Cohesion: 0.08
Nodes (21): Props, Props, Claim, Props, isAuthenticated(), InternalBasicAuthGate(), appServicesLogout(), AppServicesToken (+13 more)
...
Cohesion: 0.09
Nodes (31): Any, build_document_components(), extract_document(), get_file_acls(), process_document(), Azure Search Custom Skill: Extract document content      Input format (single, Process a single document: download, parse, extract figures, upload images, Extract user and group IDs from ADLS Gen2 ACLs for a file.      Args: (+23 more)
...
Cohesion: 0.21
Nodes (11): formatTimestamp(), ManagePromptsPage(), StatusState, listPromptAdminEntriesApi(), parseErrorMessage(), PromptAdminEntry, PromptAdminListResponse, PromptAdminMutationResponse (+3 more)

### Community 234 - "Community 234"
Cohesion: 0.15
Nodes (16): Select the appropriate file processor for a given filename.      Args:, select_processor_for_filename(), Parses simple text into a Page object., TextParser, ChunkStub, Any, LogCaptureFixture, Reload module without pytest env to trigger init warning path. (+8 more)
...
Cohesion: 0.04
Nodes (96): Any, _assistant_index_that_asked(), assistant_texts(), build_result_payload(), build_state_injection(), _completed_state(), compute_tally(), _current_question_interaction() (+88 more)
...
Cohesion: 0.07
Nodes (47): BlobManager, Any, SearchInfo, Any, BlobManager, SearchInfo, BlobManager, OpenAIEmbeddings (+39 more)
...
Cohesion: 0.22
Nodes (8): configure_global_settings(), Test text processor uses ManagedIdentityCredential with client ID., configure_global_settings wires up embedding service when configuration is compl, Figure processor is created with warning when USE_MULTIMODAL is true but OpenAI, test_figure_processor_warns_when_openai_incomplete(), test_text_processor_embeddings_setup(), test_text_processor_with_client_id(), Azure Function: Text Processor. Custom skill for Azure AI Search that merges pa
...
Cohesion: 0.67
Nodes (3): datetime, format_utc(), Blob-backed, multi-replica-safe cumulative session counter for DYNAMIC bots.  Qu
...
Cohesion: 0.07
Nodes (66): process_figure_request(), Entrypoint for Azure Search custom skill calls., GlobalSettings, build_raw_request(), build_request(), EventGridEventStub, HttpRequest, MonkeyPatch (+58 more)
...
Cohesion: 0.15
Nodes (14): ChatbotDirectory(), sortedChatbots, EmbedConfigEntry, EmbedConfigMutationResponse, EmbedConfigResponse, getEmbedConfigApi(), parseErrorMessage(), saveEmbedConfigApi() (+6 more)
...
## Knowledge Gaps
- **2482 isolated node(s):** `ChatCompletionSystemMessageParam`, `ChatCompletionUserMessageParam`, `ChatCompletionMessageParam`, `ChatCompletionToolParam`, `AsyncOpenAI` (+2477 more)
...
- **Why does `isAuthenticated()` connect `Community 137` to `Community 128`, `Community 416`, `Community 130`, `Community 132`, `Community 135`, `Community 360`, `Community 76`, `Community 16`, `Community 210`, `Community 126`, `Community 157`, `Community 158`, `Community 127`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `BlobManager` connect `Community 12` to `Community 3`, `Community 8`, `Community 140`, `Community 13`, `Community 526`, `Community 398`, `Community 146`, `Community 22`, `Community 28`, `Community 29`, `Community 31`, `Community 33`, `Community 41`, `Community 56`, `Community 72`, `Community 74`, `Community 86`, `Community 89`, `Community 1246`, `Community 97`, `Community 1270`, `Community 121`, `Community 1406`?**
